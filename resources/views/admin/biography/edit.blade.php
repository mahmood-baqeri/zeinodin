        ...
        <div class="row">
            <div class="col-lg-12" >
                ...
                <div class="panel panel-default">
                    <div class="panel-heading">ویرایش زندگی نامه </div>
                    <div class="panel-body panel_insert">

                        @include('admin.messages')

                        <form class="form" novalidate method="POST" action="{{route('biography.update' , $biography->id)}}"
                              enctype="multipart/form-data">
                            @csrf
                            @method('put')

                            <input type="hidden" name="type" value="{{$biography->type}}">
                            ...
                            <div id="home" class="tab-pane fade in active">
                                ...
                                <div class="row">
                                    ...
                                    <div class="col-75">
                                        <textarea name="metaKeywords" id="" cols="30" rows="5">{{$biography->metaKeywords}}</textarea>
                                    </div>
                                </div>
                                <div class="row">
                                    <div class="col-25">
                                    ...
                                    <div class="col-75">
                                        <textarea name="metaDescription" id="" cols="30" rows="10">{{$biography->metaDescription}}</textarea>
                                    </div>
                                </div>
                                ...
                                <div class="row description">
                                    ...
                                    <div class="col-75">
                                        <textarea class="ckeditor"  name="description">{{$biography->description}}</textarea>
                                    </div>
                                </div>
                            ...
                            <div class="row" id="btn">
                                ...
                                <a class="btn insert_form" href="{{route('biography.index')}}"><i class="fa fa-undo"></i>   بازگشت</a>
                            </div>
