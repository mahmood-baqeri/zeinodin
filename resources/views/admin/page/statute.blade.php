        ...
        <div class="row">
            <div class="col-lg-12">
                ...
                <div class="panel panel-default">
                    <div class="panel-heading">اساسنامه</div>
                    <div class="panel-body panel_insert">
                        <form id="form1" method="post" action="{{route('admin.pageUpdate' , $data->id)}}"
                            ...
                            <div class="row">
                                <div class="col-25">
                                    <label> تصویر اصلی <span style="color: red">*</span> </label>
                                </div>
                                <div class="col-75">
                            ...
                            <div class="row">
                                <div class="col-25">
                                    <label> اساسنامه<span style="color: red">*</span> </label>
                                </div>
                                <div class="col-75">
                                    <textarea class="ckeditor" id="text" name="text"
                                              rows="10">@if(!empty($data->text)){!! $data->text !!}@endif</textarea>
                                </div>
                            </div>
                            ...
                            <div class="row editorPhoto">
                                ...
                                <div class="col-30" style="width: 32% !important; margin-left: 0;">
                                    <img class="applicationsImgUrl" src="{{asset($item->photo)}}" alt="" height="250"
