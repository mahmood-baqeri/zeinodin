        ...
        <div class="row">
            <div class="col-lg-12" >
                ...
                <div class="panel panel-default">
                    <div class="panel-heading">ویرایش فعالیت </div>
                    <div class="panel-body panel_insert">

                        @include('admin.messages')

                        <form class="form" novalidate method="POST" action="{{route('works.update' , $boniadWorks->id)}}"
                            ...
                            <div id="home" class="tab-pane fade in active">
                                ...
                                <div class="row name">
                                    ...
                                    <div class="col-75">
                                        <input type="text" name="name" value="{{$boniadWorks->name}}">
                                    </div>
                                </div>
                                ...
                                <div class="row metaKeywords">
                                    ...
                                    <div class="col-75">
                                        <textarea name="metaKeywords" id="" cols="30" rows="5">{{$boniadWorks->metaKeywords}}</textarea>
                                    </div>
                                </div>
                                <div class="row metaDescription">
                                    ...
                                    <div class="col-75">
                                        <textarea name="metaDescription" id="" cols="30" rows="10">{{$boniadWorks->metaDescription}}</textarea>
                                    </div>
                                </div>
                                ...
                                <div class="row description">
                                    ...
                                    <div class="col-75">
                                        <textarea class="ckeditor"  name="description">{{$boniadWorks->description}}</textarea>
                                    </div>
                                </div>
