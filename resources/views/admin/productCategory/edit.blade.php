            ...
            <div class="col-lg-12" >
                ...
                <div class="panel panel-default">
                    ...
                    <div class="panel-body panel_insert">
                        ...
                        <form class="form" novalidate method="POST" action="{{route('productCategory.update' , $productCategory->id)}}"
                            ...
                            <div id="home" class="tab-pane fade in active">
                                ...
                                <div class="row">
                                    ...
                                    <div class="col-75">
                                        <select name="status">
                                            <option value="0" @if($productCategory->status == 0) selected @endif>غیرفعال</option>
                                ...
                                <div class="row">
                                    ...
                                    <select name="parent_id" id="" class="col-75">
                                        ...
                                        @foreach($category as $item)
                                            <option value="{{$item->id}}" @if($productCategory->parent_id == $item->id) selected @endif>{{$item->name}}</option>
                                        @endforeach
                                    </select>
                                </div>
                                ...
                                <div class="row">
                                    ...
                                    <div class="col-75">
                                        <textarea name="metaKeywords" id="" cols="30" rows="5">{{$productCategory->metaKeywords}}</textarea>
                                    </div>
                                </div>
                                ...
                                <div class="row">
                                    ...
                                    <div class="col-75">
                                        <textarea name="metaDescription" id="" cols="30" rows="10">{{$productCategory->metaDescription}}</textarea>
                                    </div>
                                </div>
