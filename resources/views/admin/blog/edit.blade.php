            ...
            <div class="col-lg-12" >
                ...
                <div class="panel panel-default">
                    ...
                    <div class="panel-body panel_insert">
                        ...
                        <form class="form" novalidate method="POST" action="{{route('blog.update' , $blog->id)}}"
                            ...
                            <div id="home" class="tab-pane fade in active">
                                ...
                                <div class="row status">
                                    ...
                                    <div class="col-75">
                                        <select name="status">
                                            <option value="0" @if($blog->status == 0) selected @endif>غیرفعال</option>
                                            <option value="1" @if($blog->status == 1) selected @endif>فعال</option>
                                        </select>
                                    </div>
                                </div>
                                ...
                                <div class="row metaKeywords">
                                    ...
                                    <div class="col-75">
                                        <textarea name="metaKeywords" id="" cols="30" rows="5">{{$blog->metaKeywords}}</textarea>
                                    </div>
                                </div>
                                <div class="row metaDescription">
                                    ...
                                    <div class="col-75">
                                        <textarea name="metaDescription" id="" cols="30" rows="10">{{$blog->metaDescription}}</textarea>
                                    </div>
                                </div>
                                <div class="row summer">
                                    ...
                                    <div class="col-75">
                                        <textarea name="summer" id="" cols="30" rows="5">{{$blog->summer}}</textarea>
                                    </div>
                                </div>
